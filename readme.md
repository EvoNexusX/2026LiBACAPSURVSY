...
| Year | Reference                                                                                                                                                                                                |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2006 | *The algorithm for berth scheduling problem by the hybrid optimization strategy GASA* — Han et al. [Paper](https://doi.org/10.1109/ICARCV.2006.345455)                                                   |
| 2013 | *Genetic Algorithm for the Dynamic Berth Allocation Problem in Real Time* — Arango et al. [Paper](https://doi.org/10.1016/B978-0-12-405163-8.00017-X)                                                    |
...
| 2015 | *A Novel Wharf-based Genetic Algorithm for Berth Allocation Planning* — Tsai et al. [Paper](https://doi.org/10.1145/2818869.2818874)                                                                     |
...
| 2019 | *A genetic algorithm based on spatiotemporal conflict between continuous berth-allocation and time-varying specific crane assignment* — Yu et al. [Paper](https://doi.org/10.1080/0305215X.2018.1507779) |
...
| 2022 | *An Improved Genetic Algorithm for Berth Scheduling at Bulk Terminal* — Hu et al. [Paper](https://doi.org/10.32604/csse.2022.029230)                                                                     |
| 2022 | *An efficient algorithm for berth and quay crane assignments considering operator performance* — Tengecha & Zhang [Paper](https://doi.org/10.3390/jmse10091232)                                          |
...
| 2026 | *DHMoGA_BQCS: A Dynamic Heuristic Multi-Objective Genetic Algorithm for Berth Allocation and Quay Crane Assignment* — Zhao et al. [Paper](https://doi.org/10.1109/ACCESS.2026.3651763)                   |
...
| 2024 | *An adaptive biased random-key genetic algorithm for the tactical berth allocation problem* — Chaves et al. [Paper](https://doi.org/10.1145/3650889.3650920)                                       |
...
| 2024 | *Integrated berth allocation and quay crane assignment and scheduling problem under the influence of various factors* — Yu et al. [Paper](https://doi.org/10.1049/cim2.70001)                |
...
| Year | Reference                                                                                                                                                                                  |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1999 | *Ant colony optimization for the ship berthing problem* — Tong et al. [Paper](https://link.springer.com/chapter/10.1007/3-540-46632-0_28)                                                  |
...
| 2011 | *The Application Research of Container Berth Allocation Based on Ant Colony Algorithms* — Yu & Wang [Paper](https://doi.org/10.1061/41184%28419%29250)                                     |
| 2014 | *Ant colony system for solving quay crane scheduling problem in container terminal* — Azza et al. [Paper](https://doi.org/10.1109/ISMS.2014.32)                                            |
