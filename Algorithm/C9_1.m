function C9_1(ship,qc,run_id,dataset_id)
    %% Set random seed
    ...
    for gen = 1:max_gen
        for i = 1:pop_size
            fitness(i) = evaluate_fitness_adjustable(pop(i,:), scenarios, qcs, berth_length);
    ...
    %writetable(T, 'C9_1_result.csv');
    outname = sprintf('C9_1_result_d%d_r%d.csv', dataset_id, run_id);
