function C7_1(ship,qc,run_id,dataset_id)
    %% Set random seed
    ...
    for gen = 1:max_gen
        for i = 1:pop_size
            [fitness(i), worst_scenarios{i}] = evaluate_fitness_minmax(pop(i,:), scenarios, qcs, berth_length);
            ...
            %best_scenario = worst_scenarios{best_idx};  %
        end
    ...
    %writetable(T, 'C7_1_result.csv');
    outname = sprintf('C7_1_result_d%d_r%d.csv', dataset_id, run_id);
